...
setenv URL	"http://www.gensat.org/GensatGenes.jsp?tsv=Y"
# Base URL of the file
setenv BASEURL www.gensat.org

# full path to log file
setenv LOGFILE	${MIRRORLOG}/${BASEURL}.log

# output directory
setenv OUTPUTDIR	${DATADOWNLOADS}/${BASEURL}/report

# output file
setenv OUTPUTFILE	${OUTPUTDIR}/EntrezGeneIds.txt
...
wget -o ${LOGFILE} -O${OUTPUTFILE} -rNS -t 10 "${URL}" >>& /dev/null
