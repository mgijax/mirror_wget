...
# run mirrors
cd ${DOWNLOADS_DIR}
wget -o ${LOGFILE_ORTH} -S -t 10 -nd -m "${URL_ORTH}"

wget -o ${LOGFILE_EG} -S -t 10 -nd -m "${URL_EG}"

wget -o ${LOGFILE_EXPR} -S -t 10 -nd -m "${URL_EXPR}"

wget -o ${LOGFILE_TRANS} -S -t 10 -nd -m "${URL_TRANS}"
